...
//mostrar y esconder la imagen, tambien puede usarse toggle solo
...
$("#abajo").css("color", "green")
    .delay(6000) //sirve para retrasar las funciones que vienen abajo
    .slideUp(2000)
    .slideDown(2000);
//DIAPO 32
...
$(document).ready(function() {
    $(".btnComprar").click(function(e) {
        ...
        //$(e.target).parent().slideUp("slow"); para desaparecer la fila
